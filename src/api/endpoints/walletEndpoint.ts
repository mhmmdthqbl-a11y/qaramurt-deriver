...
export const paymentRide = 'ride/payment'
export const fleetWallet = 'fleetWallet/history'
export const fleetWithdraw = 'fleet/withdraw-request'
export const fleetWithdrawRequest = 'fleetWallet/withdraw-request'